window.addEventListener("load", function(e){
    let form = document.querySelector("#formCRUD");
    ...
    form.addEventListener("submit", function(e){
        ...
        let productPrice = document.getElementsByName("productPrice")[0].value;
        if(productPrice == ""){
        ...
        let productCategory = document.getElementsByName("productCategory")[0].value;
        if(productCategory == ""){
